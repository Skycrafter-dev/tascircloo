...
public:
	...
	/// Restore the accumulated sleep timer when cloning an exact world state.
	void SetSleepTime(float32 sleepTime);

	/// Read the accumulated sleep timer for exact state snapshots.
...
inline void b2Body::SetSleepTime(float32 sleepTime)
{
